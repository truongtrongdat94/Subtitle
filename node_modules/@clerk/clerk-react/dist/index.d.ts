...
declare const __experimental_PricingTable: {
    (props: Without<WithClerkProp<__experimental_PricingTableProps & FallbackProp>, "clerk">): React.JSX.Element | null;
    displayName: string;
};
